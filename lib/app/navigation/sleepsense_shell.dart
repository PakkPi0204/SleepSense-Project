...
/// The four-tab shell. Tabs live in an IndexedStack so switching between them
/// keeps each screen's state and scroll position — see DashboardRefreshBus for
/// how Home is told to reload when something changes on another tab.
